...
namespace BigBoss.Controllers {
    ...
    public class AccountController : Controller {
        ...
        //----------------------dodatak registraciji ----------------

        public ActionResult FinishRegistration() {
            if(UserManager.FindById(User.Identity.GetUserId()).FinishedRegistration == true) {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl) {
            ...
            switch(result) {
                case SignInStatus.Success:
                    if(UserManager.IsRegistrationFinished(model.Username)) {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model) {
            if(ModelState.IsValid) {
                ...
                if(result.Succeeded) {
                    //Trebalo bi korisniku poslati mail sa linkom za potvrdu. Kod ispod prijavljuje korisnika nakon registracije.
